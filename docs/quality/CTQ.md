...
| CTQ-004 | El usuario necesita que sus respuestas estén protegidas de accesos no autorizados | Protección de datos de los encuestados | % de accesos no autorizados bloqueados | 100% de intentos rechazados | Prueba de acceso restringido | Must | #4 |
